...
import {AaveInterface, DTokenInterface, EventEmitterInterface} from "./interface.sol";
import {Helpers} from "./helpers.sol";

abstract contract AaveResolver is Events, Helpers {
    EventEmitterInterface internal constant eventEmitter = EventEmitterInterface(0x0Be3A0E2944b1C43799E2d447d1367A397c4F573);
    /**
    ...
    returns (string memory _eventName, bytes memory _eventParam)
    {
        ...
        eventEmitter.emitAaveDeposit(_token, _amt);
    }
...
//    }
    ...
    returns (string memory _eventName, bytes memory _eventParam)
    {
        ...
        eventEmitter.emitAaveWithdraw(_token, _amt);
    }
    ...
    returns (string memory _eventName, bytes memory _eventParam)
    {
        ...
        eventEmitter.emitAaveBorrow(_token, _amt);
    }
...
//    }
    ...
    returns (string memory _eventName, bytes memory _eventParam)
    {
        ...
        eventEmitter.emitAavePayback(_token, _amt);
    }
